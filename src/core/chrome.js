...
// C.edge/C.edge2 are structural boxes; any other colour is a state, so it draws
...
function rr(x,y,w,h,r){                 // no roundRect in older engines
  // arcTo throws on a negative radius, and a squeezed box hands one in
...
/* lerpC hands back an rgb() string, so a twice-lerped colour arrives in that form */
...
/* (x, y) is the box's top-right corner */
...
// o.marks names extra needles, one class suffix each; o.mv their live values in the same order
