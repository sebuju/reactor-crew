"use strict";
// chunks: steady series
/* steady = each panel radiates Stefan-Boltzmann and the panel heat balances at rest (preset 0, 20 s); series = the analytic Jensen check that decides the SINK_MARGIN row, plus the rated-rest check that the fleet sits at RAD_TDES within its own series spread */
