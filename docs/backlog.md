...
- 25/09/26 - The control absorber never melts: Ag-In-Cd goes at about 800 °C, first in the core, fails its clad, runs down and blocks the lower core, and takes its bank's worth with it; B4C blades fail on their steel eutectic. Here a bank keeps its place and worth through any melt.
